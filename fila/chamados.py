# Um pequeno departamento de TI atende no máximo 6 chamados por vez.
# Crie uma fila circular onde o atendente remove o chamado mais antigo (Início) e novos chamados são adicionados ao Fim.
# Exiba o estado do vetor após cada operação.
